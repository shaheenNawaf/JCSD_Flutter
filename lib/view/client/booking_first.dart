...
class _ClientBooking1State extends State<ClientBooking1> {
  ...
  Widget _buildHomeServiceOption() {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isHomeServiceSelected ? 'Home Service' : 'In-Shop Service',
            style: const TextStyle(
              fontFamily: 'Nunito',
              fontSize: 16,
            ),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          bool isPM = ['1:00', '2:00', '3:00', '4:00', '5:00'].contains(time);
          if (isPM && hour != 12) hour += 12;

          bool isDisabled =
              selectedDate.day == currentDate.day && hour <= currentDate.hour;
