...
class AddItemTypeModal extends StatefulWidget {
  const AddItemTypeModal({super.key});

  @override
  _AddItemTypeModalState createState() => _AddItemTypeModalState();
}

class _AddItemTypeModalState extends State<AddItemTypeModal> {
