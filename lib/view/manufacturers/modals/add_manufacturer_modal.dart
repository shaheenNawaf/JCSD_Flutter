...
class AddManufacturerModal extends ConsumerStatefulWidget {
  final bool isVisibleContext;

  const AddManufacturerModal({super.key, this.isVisibleContext = true});

  @override
  ConsumerState<AddManufacturerModal> createState() =>
      _AddManufacturerModalState();
}

class _AddManufacturerModalState extends ConsumerState<AddManufacturerModal> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      ToastManager()
          .showToast(context, 'Manufacturer added successfully!', Colors.green);
      Navigator.pop(context);
    } catch (e) {
      print("Error adding manufacturer: $e");
      ToastManager()
          .showToast(context, 'Failed to add manufacturer: $e', Colors.red);
    } finally {
