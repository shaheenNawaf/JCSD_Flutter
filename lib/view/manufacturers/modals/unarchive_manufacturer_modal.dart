...
class UnarchiveManufacturerModal extends ConsumerStatefulWidget {
  final int manufacturerID;
  final String manufacturerName;
  final bool isVisibleContext;

  const UnarchiveManufacturerModal(
      {super.key,
      required this.manufacturerID,
      required this.manufacturerName,
      this.isVisibleContext = false});

  @override
  ConsumerState<UnarchiveManufacturerModal> createState() =>
      _UnarchiveManufacturerModalState();
}

class _UnarchiveManufacturerModalState
    extends ConsumerState<UnarchiveManufacturerModal> {
    ...
    try {
      await ref
          ...
          .updateManufacturerVisibility(
              manufacturerID: widget.manufacturerID, newIsActive: true);
      ToastManager().showToast(context,
          'Manufacturer "${widget.manufacturerName}" restored.', Colors.green);
      Navigator.pop(context);
    } catch (e) {
      print("Error restoring manufacturer ${widget.manufacturerID}: $e");
      ToastManager().showToast(context, 'Failed to restore: $e', Colors.red);
