...
Future<void> updateVisibility(int serviceID, bool isActive) async {
  ...
  //Fixed Add
  Future<void> addService(String serviceName, double minPrice, double maxPrice) async {
    try{  
  ...
  //Fixed Update
  Future<void> updateService(int serviceID, String serviceName, double minPrice, double maxPrice) async {
    try{
