...
class RejectCashAdvanceModal extends StatefulWidget {
  final int id;
  final VoidCallback onSuccess;

  const RejectCashAdvanceModal({
    super.key,
    required this.id,
  ...
  @override
  _RejectCashAdvanceModalState createState() => _RejectCashAdvanceModalState();
}

class _RejectCashAdvanceModalState extends State<RejectCashAdvanceModal> {
  bool _loading = false;
